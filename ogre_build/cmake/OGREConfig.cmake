...
set(OGRE_STATIC OFF)
set(OGRE_MEDIA_DIR "${PACKAGE_PREFIX_DIR}/share/OGRE/Media")
set(OGRE_PLUGIN_DIR "${PACKAGE_PREFIX_DIR}/lib/OGRE")
set(OGRE_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/share/OGRE") 
...
if()
    list(APPEND OGRE_INCLUDE_DIRS /usr/include)
    list(APPEND OGRE_LIBRARIES /usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libpthread.so)
endif()
...
macro(ogre_declare_plugin TYPE COMPONENT)
    ...
    set(OGRE_${TYPE}_${COMPONENT}_LIBRARIES "${TYPE}${COMPONENT}")
...
if(ON)
    ...
    if(TRUE)
        list(APPEND OGRE_Bites_INCLUDE_DIRS /usr/include/SDL2)
        list(APPEND OGRE_Bites_LIBRARIES /usr/lib/x86_64-linux-gnu/libSDL2main.a;/usr/lib/x86_64-linux-gnu/libSDL2.so;-lpthread)
        
        list(APPEND OGRE_INCLUDE_DIRS /usr/include/SDL2)
        list(APPEND OGRE_LIBRARIES /usr/lib/x86_64-linux-gnu/libSDL2main.a;/usr/lib/x86_64-linux-gnu/libSDL2.so;-lpthread)
    endif()
endif()
if(ON)
